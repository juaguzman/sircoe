...
class acciones
{
    static function listarEmpleadosDep($id)
    {
        ...
        while ($campo=mysqli_fetch_object($result)) 
        {
            ...
            echo "<tr><td>$campo->cedula</td><td>$campo->codigo</td><td>$campo->nombres</td><td>$campo->apellidos</td><td>$campo->dependencia</td><td>$estado</td><td><a href=modificarEmpleado.php?cedu=$campo->cedula><img src=../../imagenes/iconos/horario.png width=30px heigt=30px ></a></td></tr>";
        }
        echo '<table>';
    }
